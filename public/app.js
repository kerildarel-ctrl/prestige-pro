    ...
    <div class="main-wrapper">
      <header class="top-header">
        ...
        <div class="header-actions">
          <button class="icon-btn" onclick="refresh()" title="Rafraîchir les données">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.5 2v6h-6M2.13 15.57a10 10 0 1 0 3.8-11.45L2.5 8"/></svg>
          </button>
